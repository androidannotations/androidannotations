...
public class TextChangeValidator implements ElementValidator {
	...
	public TextChangeValidator(ProcessingEnvironment processingEnv, IRClass rClass) {
	...
	private void haveTextChangedMethodParameters(ExecutableElement executableElement, IsValid valid) {
