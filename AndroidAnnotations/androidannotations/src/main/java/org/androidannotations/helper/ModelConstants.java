...
public abstract class ModelConstants {
	...
	@SuppressWarnings("unchecked")
	public static final List<Class<? extends Annotation>> VALID_ENHANCED_COMPONENT_ANNOTATIONS = asList(EApplication.class, EActivity.class, EViewGroup.class, EView.class, EBean.class, ECustom.class, EService.class, EReceiver.class, EProvider.class, EFragment.class);
