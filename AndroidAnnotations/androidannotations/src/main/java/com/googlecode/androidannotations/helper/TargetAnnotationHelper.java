...
public class TargetAnnotationHelper extends AnnotationHelper implements HasTarget {
	...
	public DeclaredType extractAnnotationClassParameter(Element element) {
		return (DeclaredType) extractAnnotationClassesParameter(element);
	}

	public List<DeclaredType> extractAnnotationClassesArrayParameter(Element element) {
		return extractAnnotationClassesArrayValue(element, target);
	}

	private Object extractAnnotationClassesParameter(Element element) {
		return extractAnnotationClassesValue(element, target);
	}
