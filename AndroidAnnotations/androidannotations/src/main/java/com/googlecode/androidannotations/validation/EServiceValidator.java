...
public class EServiceValidator implements ElementValidator {

	private final ValidatorHelper validatorHelper;
	private final AndroidManifest androidManifest;

	public EServiceValidator(ProcessingEnvironment processingEnv, AndroidManifest androidManifest) {
	...
	public boolean validate(Element element, AnnotationElements validatedElements) {
		...
		validatorHelper.extendsService((TypeElement) element, valid);
