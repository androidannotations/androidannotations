...
public class ActivityWithValidReceiver extends Activity {
	...
	protected void onAction1Bis() {

	}

	@Receiver(actions = "org.androidannotations.ACTION_2", registerAt = Receiver.RegisterAt.OnResumeOnPause)
	protected void onAction2(Intent intent) {
