...
@EView
public class GenericButton<T extends Number> extends Button {
	...
	public GenericButton(Context context, int constructorParameter) {
		super(context);
		this.constructorParameter = constructorParameter;
	}

	public GenericButton(Context context, AttributeSet attrs) {
		super(context, attrs);
	}
